...
import 'package:tiktok_clone/common_widget/buttons/like_button/src/painter/bubbles_painter.dart';
import 'package:tiktok_clone/common_widget/buttons/like_button/src/painter/circle_painter.dart';
import 'package:tiktok_clone/common_widget/buttons/like_button/src/utils/like_button_util.dart';
...
class LikeButtonState extends State<LikeButton> with TickerProviderStateMixin {
  ...
  void didUpdateWidget(LikeButton oldWidget) {
    ...
    if (controller?.duration != widget.animationDuration) {
      controller?.dispose();
      controller =
          AnimationController(duration: widget.animationDuration, vsync: this);
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Transform.scale(
                  scale: ((_isLiked ?? true) && controller!.isAnimating)
  ...
  Widget _createLikeCountWidget(int? likeCount, bool isLiked, String text) {
    return widget.countBuilder?.call(likeCount, isLiked, text) ??
        Text(text, style: TextStyle(color: widget.countColor ?? Colors.white));
  }

  void onTap() {
    if (controller!.isAnimating || _likeCountController!.isAnimating) {
      return;
    }
